<div class="project_row">
    ...
    <div class="more_info">
        ...
        <div class="grid_3">
            ...
            <ul><li>Personas were developed based on data retrieved from surveys sent out to club members in addition to various interviews of club officers</li></ul>
        </div>

        <div class="grid_3">
            <p><b>Information Architecture</b></p>
            <ul><li>Preliminary Information Architecture was developed from card sorting exercises executed using SimpleSort</li></ul>
        </div>

        <div class="grid_3">
            <p><b>Prototype</b></p>
            <ul><li>Clickable Prototype was developed using Axure and modified incrementally using feedback from conducted usability tests</li></ul>
        </div>

        <div class="grid_3">
            <p><b>Release</b></p>
            <ul><li>Finished version was developed using a combination of Google Sites and custom HTML and CSS. Photoshop was also used extensively for the visual design</li></ul>
        </div>
